...
export default function Footer({ bride, groom, weddingDate }: FooterProps) {
  return (
    <footer className="py-16 relative overflow-hidden" style={{ background: 'linear-gradient(to bottom, #faf8f3 0%, #f5f1e8 100%)' }}>
      ...
      <div className="absolute top-10 left-10 opacity-20">
        <i className="flaticon-favorite-heart-button text-6xl" style={{ color: '#b19a56' }}></i>
      </div>
