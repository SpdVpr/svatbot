          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="text-center hover-lift">
                ...
                <div className="text-sm sm:text-lg font-bold text-gray-900">{stats.totalAccommodations}</div>
              ...
              <div className="text-center hover-lift">
                <div className="flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 bg-primary-100 rounded-lg mx-auto mb-1 float-enhanced" style={{ animationDelay: '0.2s' }}>
                  <Bed className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary-600" />
                </div>
                <div className="text-sm sm:text-lg font-bold text-gray-900">{stats.availableRooms}</div>
              ...
              <div className="text-center hover-lift">
                ...
                <div className="text-sm sm:text-lg font-bold text-gray-900">{stats.occupiedRooms}</div>
